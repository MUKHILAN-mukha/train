...
void displayAvailableTrains(struct Train trains[], int n) {
    ...
    printf("---------------------------------------------------------------------------------------------------\n");
    for (int i = 0; i < n; i++) {
        printf("| %-5d| %-10s| %-12s| %-13s| %-26s| %-10d| %-15s| %-13s| %-12d|\n",
...
void bookTicket(struct Train *train, struct Passenger passengers[], int *num_tickets) {
    ...
    for (int i = 0; i < num_tickets_to_book; i++) {
        printf("\nPassenger %d:\n", *num_tickets + i + 1);
        printf("Name: ");
...
int main() {
    ...
    struct Train trains[] = {
        ...
        {2, "08/05/2024", "MS", "CAPE", "Kanyakumari Express", 12634, "09:00", "11:30", 2},
        {3, "09/05/2024", "MS", "TPJ", "Tiruchirappalli Rockfort Express", 12653, "10:30", "13:00", 3},
        {4, "09/05/2024", "MS", "NJT", "Nagercoil Guruvayur Express", 16344, "10:30", "13:00", 2},
        {5, "08/05/2024", "MS", "KKDI", "Karaikudi Pallavan Express", 12605, "10:30", "13:00", 3},
        {6, "09/05/2024", "MS", "MDU", "Madurai Pandian Express", 12637, "10:30", "13:00", 1},
        {7, "10/05/2024", "MS", "TJ", "Thanjavur Uzhavan Express", 16184, "10:30", "13:00", 3},
        {8, "10/05/2024", "MS", "KMU", "Kumbakonam Express", 16182, "10:30", "13:00", 2}
    };
